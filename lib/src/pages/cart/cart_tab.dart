...
import 'package:lojinha/src/pages/home/components/common_widgets/payment_dialog.dart';
...
class _CartTabState extends State<CartTab> {
  ...
  void removeItemFromCart(CartItemModel cartItem) {
    setState(() {
      appData.carItems.remove(cartItem);
  ...
  double cartTotalPrice() {
    ...
    for (var item in appData.carItems) {
        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: appData.carItems.length,
              itemBuilder: (_, index) {
                return CartTile(
                  cartItem: appData.carItems[index],
